...
class HeteroLayoutFromFile(BaseEnvironment):
    """
    ...
    name = "layout_from_file/hetero_agents"
    agent_subclasses = ["HeteroMobileAgent", "BasicPlanner"]
...
@scenario_registry.add
class SplitLayout(HeteroLayoutFromFile):
    """
